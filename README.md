...
- 🌐 **Chat Firehose & User Stalking**:
  - **Multi-Stream Firehose**: Stream live chat messages across public Twitch log feeds (*Spanix, Supa, Susgee, Nadeko, Logxx, Catquery*).
...
If you encounter bugs, crashes, or feature requests regarding Sloperino-specific features (*Roles, Clips, Firehose, Stalk, 7TV*), please submit an issue [in our issue tracker](https://github.com/w77hxhx/sloperino/issues).
