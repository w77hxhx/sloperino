                             ...
                             const Paths &paths)
{
    ...
    {
        auto *box = new QMessageBox(QMessageBox::Information, "Sloperino",
                                    "Show changelog?",
...
FirehoseManager *Application::getFirehose()
{
    assertInGuiThread();
    assert(this->firehose);

    return this->firehose.get();
}
